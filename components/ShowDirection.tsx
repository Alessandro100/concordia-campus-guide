...
super(props)
    ...
    async getDirections(startLoc, desLoc) {
        ...
        try {
          const resp = await fetch(`https://maps.googleapis.com/maps/api/directions/json?origin=${startLoc}&destination=${desLoc}&key=AIzaSyDpY_ACPWoo3mVPPmiLKQe1aBhjkDYlwJI`);
