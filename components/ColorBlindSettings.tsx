...
/**
component that shows 3 radio buttons to set the colorBlindMode for the application.
Accesssible through the menu under "settings"
*/
    ...
    return (
      <View>
        ...
        <RadioButton
          ...
          status={
            currentColorBlindMode === colorBlindMode.protanomaly
              ? "checked"
              : "unchecked"
          }
          onPress={() => {
        ...
        <RadioButton
          ...
          status={
            currentColorBlindMode === colorBlindMode.deuteranomaly
              ? "checked"
              : "unchecked"
          }
          onPress={() => {
        ...
        <RadioButton
          ...
          status={
            currentColorBlindMode === colorBlindMode.tritanomaly
              ? "checked"
              : "unchecked"
          }
          onPress={() => {
